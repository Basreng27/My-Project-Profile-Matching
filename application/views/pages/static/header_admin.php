        ...
        <div id="userbox" class="userbox">
            <a href="#" data-toggle="dropdown">
                <div class="profile-info">
                    ...
                    $nama = $this->Admin_model->nama($nip)->result();
                    ?>
                    <span class="name">
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled">
                    <li class="divider"></li>
                    <li>
                        <a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>profile_admin"><i class="fa fa-user"></i> My Profile</a>
                    </li>
                    <li>
                    ...
                    <ul class="nav nav-main">
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="nav nav-children">
                                <li>
                                    <a href="<?php echo base_url(); ?>daftar_dosen">
                                        Daftar Dosen
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>daftar_mahasiswa">
                                        Daftar Mahasiswa
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>daftar_proposal">
                                        Daftar Proposal
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>daftar_judul">
                                        Daftar Judul
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="nav nav-children">
                                <li>
                                    <a href="<?php echo base_url(); ?>tambah_dosen">
                                        Tambah Dosen
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>tambah_pengajuan_judul">
                                        Tambah Pengajuan
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>tambah_kategori">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>pemilihan_pembimbing">
